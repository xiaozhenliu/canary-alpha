...
const V1_EVALS_MARKER_PREFIX = 'preparing mcp_computer_history_mcp_v1_evals_';
...
describe('hermes-side tools.include drift contract', () => {
  ...
  it('E2E script tool marker references a registered tool (internal-status)', () => {
    // The E2E script checks for the marker 'preparing mcp_computer_history_mcp_internal_status'.
    ...
    const E2E_TOOL_MARKER = 'preparing mcp_computer_history_mcp_internal_status';
    const E2E_MARKER_PREFIX = 'preparing mcp_computer_history_mcp_';
    expect(
